  ...
  class Lid1:
    ...
    class OnderdeelP:  
      ...
      def subonderdeel_4(self) -> Result:
        if (self.woning_waarde + self.aanhorigheden_waarde) <= 525000:
      ...
      def startersvrijstelling(self) -> Result:
        if (self.verkrijging_woning and self.subonderdeel_1 and self.subonderdeel_2 and self.subonderdeel_3 and self.subonderdeel_4):
          return Result("Artikel 15, lid 1, onderdeel p", True, "Startersvrijstelling van toepassing", (self.verkrijging_woning, self.subonderdeel_1, self.subonderdeel_2, self.subonderdeel_3, self.subonderdeel_4))
        else:
          return Result("Artikel 15, lid 1, onderdeel p", False, "Startersvrijstelling niet van toepassing", (self.verkrijging_woning, self.subonderdeel_1, self.subonderdeel_2, self.subonderdeel_3, self.subonderdeel_4))
